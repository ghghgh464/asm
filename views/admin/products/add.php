                    ...
                    <form method="POST" enctype="multipart/form-data" id="add-product-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="sale_price" name="sale_price" 
                                       value="<?php echo $_POST['sale_price'] ?? ''; ?>" min="0" step="1000">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="stock" name="stock" 
                                       value="<?php echo $_POST['stock'] ?? '0'; ?>" min="0">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="4"
                                      placeholder="Nhập mô tả chi tiết về sản phẩm..."><?php echo $_POST['description'] ?? ''; ?></textarea>
                        </div>
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            ...
                            <strong>Tên sản phẩm:</strong> Nhập tên rõ ràng, dễ hiểu
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-info-circle text-info me-2"></i>
                            <strong>Danh mục:</strong> Chọn danh mục phù hợp
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-info-circle text-info me-2"></i>
                            <strong>Giá:</strong> Nhập giá bằng VNĐ, không có dấu phẩy
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-info-circle text-info me-2"></i>
                            <strong>Hình ảnh:</strong> Sử dụng ảnh chất lượng cao
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-info-circle text-info me-2"></i>
